...
@section('admin-content')
    {!! breadcrumbs(['Admin Panel' => 'admin', 'DP Submissions Queue' => 'admin/claims/pending']) !!}
    

    <h1>
        DP Submissions Queue
    </h1>
            ...
            @foreach ($submissions as $submission)
                <div class="logs-table-row">
                    <div class="row flex-wrap">
                        <div class="col-md-1">
                            <div class="logs-table-cell">{!! $submission->id !!}</div>
                        </div>
                        <div class="col-md-3">
                            <div class="logs-table-cell">{!! $submission->user->displayName !!}</div>
                        </div>
                        <div class="col-md-3">
                            <div class="logs-table-cell">{!! $submission->url !!}</div>
                        </div>
                        <div class="col-md-3">
